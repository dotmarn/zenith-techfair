...
{
    public $super_sessions, $firstname, $lastname, $email, $phone, $gender, $account_number, $have_an_account, $job_function, $industry_type, $area_of_responsibility, $selectedInterests = [];
    ...
    public function bookSummit()
    {
        $this->validate([
            ...
            'account_number' => ['required_if:have_an_account,yes', 'numeric', 'digits:10'],
