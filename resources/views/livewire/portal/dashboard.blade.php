@section('title', 'Zenith Tech Fair Portal::Dashboard')
@section('styles')
                ...
                <tbody class="divide-y divide-gray-200 font-Mulish text-sm">
                    ...
                    {{-- @foreach ($registrations as $item)
                        <tr class="border-2 border-main text-center">
                            ...
                            <td class="px-6 py-4 font-normal">
                                {{ formatHaveAnAccount($item->have_an_account) }}
                            </td>
                            <td class="px-6 py-4 font-normal">
                                {{ $item->industry }}
                            </td>
                            ...
                            <td class="px-6 py-4 font-normal">
                                {{ formatImporterOrExporter($item->importer_or_exporter) }}
                            </td>
                            ...
                            <td class="px-6 py-4 font-light text-[#323232] flex space-x-3">
                                <a href="{{ route('portal.view', $item->token) }}" class="bg-[#063970] text-white py-1 px-2 rounded-md" title="View">
